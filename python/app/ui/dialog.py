...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.dateWidget = QtGui.QWidget(self.widget)
        ...
        self.takeView = QtGui.QListView(self.dateWidget)
        self.takeView.setObjectName("takeView")
        self.verticalLayout_3.addWidget(self.takeView)
        self.horizontalLayout_3.addWidget(self.dateWidget)
        self.filesWidget = QtGui.QWidget(self.widget)
        ...
        self.fileView = QtGui.QListView(self.filesWidget)
        self.fileView.setObjectName("fileView")
        self.verticalLayout.addWidget(self.fileView)
        self.horizontalLayout_3.addWidget(self.filesWidget)
        self.verticalLayout_2.addWidget(self.widget)
        self.ingestButton = QtGui.QPushButton(Dialog)
        self.ingestButton.setObjectName("ingestButton")
        self.verticalLayout_2.addWidget(self.ingestButton)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.ingestButton.setText(QtGui.QApplication.translate("Dialog", "Ingest...", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionIngestFiles.setText(QtGui.QApplication.translate("Dialog", "IngestFiles", None, QtGui.QApplication.UnicodeUTF8))
        self.actionIngestFiles.setToolTip(QtGui.QApplication.translate("Dialog", "Ingest Files", None, QtGui.QApplication.UnicodeUTF8))
